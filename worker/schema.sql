...
-- their best score, their best level, and when it happened. No IP addresses,
-- no user agents, no names typed by a human, nothing that identifies a person
-- or a device. The display tag is derived from the id on read, never stored
-- or submitted.
--
